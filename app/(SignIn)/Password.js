...
const Password = ({ formSubmit, password, confirmpass, setPassword, setConfirmPass, buttonLabel, headerLabel }) => {
  ...
  return (
    ...
    >
      ...
      <Pressable
        ...
        className={`bg-TealGreen mb-8 py-4 px-4 h-max mt-10 mx-auto rounded-md ${
